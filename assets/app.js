...
var $author$project$Main$newsItem = F3(
	function (date, body, link) {
		return A2(
			$elm$html$Html$article,
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('news-item')
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('date-pill')
						]),
					_List_fromArray(
						[
					...
					$elm$html$Html$p,
					_List_Nil,
					$elm$core$String$isEmpty(link) ? _List_fromArray(
						[
...
var $author$project$Main$homeView = A2(
	...
	_List_fromArray(
		[
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$text('I obtained my PhD in Statistics from the London School of Economics and Political Science, supervised by '),
									A2(
									$elm$html$Html$a,
									_List_fromArray(
										[
											$elm$html$Html$Attributes$href('https://personal.lse.ac.uk/wangt60'),
											$elm$html$Html$Attributes$target('_blank')
										]),
									_List_fromArray(
										[
											$elm$html$Html$text('Tengyao Wang')
										])),
									...
									_List_fromArray(
										[
											$elm$html$Html$Attributes$href('https://personal.lse.ac.uk/cheny100/'),
											$elm$html$Html$Attributes$target('_blank')
										]),
									_List_fromArray(
										[
											$elm$html$Html$text('Yining Chen')
										])),
									$elm$html$Html$text('.')
								])),
							A2(
							...
							_List_fromArray(
								[
									$elm$html$Html$Attributes$class('quick-links')
								]),
							_List_fromArray(
								[
									A2(
									...
									_List_fromArray(
										[
											$elm$html$Html$Attributes$href('https://scholar.google.com/citations?user=XnH5giYAAAAJ&hl=en&oi=sra'),
											$elm$html$Html$Attributes$target('_blank')
										]),
									_List_fromArray(
										[
									...
									_List_fromArray(
										[
											$elm$html$Html$Attributes$href('https://github.com/YANG1030'),
											$elm$html$Html$Attributes$target('_blank')
										]),
									_List_fromArray(
										[
									...
									_List_fromArray(
										[
											$elm$html$Html$Attributes$href('https://www.linkedin.com/in/xuzhi-yang-9257871b1/'),
											$elm$html$Html$Attributes$target('_blank')
										]),
									_List_fromArray(
										[
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('section-band')
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('news-list')
						]),
					_List_fromArray(
						[
...
var $author$project$Main$linkView = function (link) {
	return A2(
		$elm$html$Html$a,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$href(link.h),
				$elm$html$Html$Attributes$target('_blank')
			]),
		_List_fromArray(
			[
...
var $author$project$Main$paperCard = function (paper) {
	return A2(
		$elm$html$Html$article,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('paper-card')
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('authors')
					]),
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('venue')
					]),
				_List_fromArray(
					[
...
var $author$project$Main$teachingView = A2(
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$elm$html$Html$text('London School of Economics')
				])),
			A2(
			$elm$html$Html$ul,
			_List_Nil,
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text('ST102 Elementary Statistical Theory, Sep 2021 - Mar 2025')
						])),
					A2(
					$elm$html$Html$li,
					_List_Nil,
					_List_fromArray(
						[
							$elm$html$Html$text('ST457 Graph Data Analysis and Representation Learning, Oct 2022 - Jan 2023')
						])),
					A2(
					$elm$html$Html$li,
					_List_Nil,
					_List_fromArray(
						[
							$elm$html$Html$text('ST447 Data Analysis and Statistical Methods, Oct 2022 - Jan 2023')
						]))
				])),
			A2(
			$elm$html$Html$h3,
			...
			_List_fromArray(
				[
					$elm$html$Html$text('Southern University of Science and Technology')
				])),
			A2(
			$elm$html$Html$ul,
			_List_Nil,
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text('STA5004 Functional Data Analysis, Feb 2021 - Jun 2021')
						])),
					A2(
					$elm$html$Html$li,
					_List_Nil,
					_List_fromArray(
						[
							$elm$html$Html$text('MA204 Mathematics Statistics, Feb 2020 - Jun 2020')
						]))
				]))
		]));
var $author$project$Main$currentSection = function (section) {
	switch (section) {
		case 0:
			return $author$project$Main$homeView;
		case 1:
			return $author$project$Main$papersView;
		case 2:
			return $author$project$Main$talksView;
		default:
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										A3($author$project$Main$navButton, model, 0, 'Home'),
